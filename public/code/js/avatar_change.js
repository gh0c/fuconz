...
$(document).ready(function(){
    ...
    //                                                $.post('url', data.result);
                ...
                $('<img/>').attr('src', newImgUrl).load(function() {
                    ...
                    var newImgHolder = $(".box-new-img-holder");
                    var uploadedInfoHolder = $('.uploaded-info-holder');
                    uploadedInfoHolder.html(info);

                    uploadedInfoHolder.hide().slideDown(700, function() {
                    });
                    newImgHolder.removeClass("display-none");
